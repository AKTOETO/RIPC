...
struct shm_t
{
    ...
    // Это неправильно так как соединений может быть несколько, а общая память создается на пару процессов
    //struct connection_t *m_conn_p; // указатель на объект соединения 
};
